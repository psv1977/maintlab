    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('operational', 'Operativo'), ('in_maintenance', 'En mantenimiento'), ('out_of_service', 'Fuera de servicio'), ('retired', 'Retirado')], default='operational', max_length=20)),
